                    ...
                    Expanded(
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, i) {
                          ...
                          final ref = (r['order_ref'] ?? '').toString();
                          final customer = (r['customers'] is Map ? r['customers']['name'] : null)?.toString() ?? '';
                          ...
                          String budgeter = '-';
                          final assigns = (r['assignments'] is List) ? (r['assignments'] as List) : const [];
